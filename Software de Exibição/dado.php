...
if ((count(array_keys($ls_dados)) <= 1)) {
    ...
    <script>
        ...
        title: "Dados não encontrados!",
                html: '<p>Não existem dados para a data selecionada. </p><p>A última transmissão para essa estação é: <?= $lastData ?></p>'
        }
        };
        ...
        <div id="accordion">
            ...
            <div>
                <table class="table1 tablesorter" id="tabela" style="width: 85%;">
                    ...
                    <thead>
                        <tr>
                            <th class="colUltimoEnvio" scope="col"><img class="thImage" alt="Hor&aacute;rio" title="HOR&Aacute;RIO" src="img/datahora.png"></br><text class="thTitulo">Horário</text></img></th>
                            <?php
                            foreach ($lsSensores as &$value) {
                                if (is_array($value)) {
                                    continue;
